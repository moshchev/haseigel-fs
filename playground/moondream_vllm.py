...
from app.loaders.loaders import ImageLoader
...
async def main(image_loader, moondream_processor, categories, batch_size=2):
...
#     asyncio.run(main(image_loader, moondream, categories, batch_size=2))
#     end_time = time.time()
